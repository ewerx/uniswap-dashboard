 ...
 */
const documents = {
    "query Pools($first: Int = 100, $skip: Int = 0, $orderBy: Pool_orderBy = totalValueLockedUSD, $orderDirection: OrderDirection = desc, $poolDayDataCount: Int = 2) {\n  pools(\n    first: $first\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    id\n    token0 {\n      id\n      symbol\n      name\n    }\n    token1 {\n      id\n      symbol\n      name\n    }\n    totalValueLockedUSD\n    volumeUSD\n    poolDayData(first: $poolDayDataCount, orderBy: date, orderDirection: desc) {\n      date\n      open\n      close\n      low\n      high\n      volumeUSD\n      tvlUSD\n    }\n  }\n}": types.PoolsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Pools($first: Int = 100, $skip: Int = 0, $orderBy: Pool_orderBy = totalValueLockedUSD, $orderDirection: OrderDirection = desc, $poolDayDataCount: Int = 2) {\n  pools(\n    first: $first\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    id\n    token0 {\n      id\n      symbol\n      name\n    }\n    token1 {\n      id\n      symbol\n      name\n    }\n    totalValueLockedUSD\n    volumeUSD\n    poolDayData(first: $poolDayDataCount, orderBy: date, orderDirection: desc) {\n      date\n      open\n      close\n      low\n      high\n      volumeUSD\n      tvlUSD\n    }\n  }\n}"): (typeof documents)["query Pools($first: Int = 100, $skip: Int = 0, $orderBy: Pool_orderBy = totalValueLockedUSD, $orderDirection: OrderDirection = desc, $poolDayDataCount: Int = 2) {\n  pools(\n    first: $first\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    id\n    token0 {\n      id\n      symbol\n      name\n    }\n    token1 {\n      id\n      symbol\n      name\n    }\n    totalValueLockedUSD\n    volumeUSD\n    poolDayData(first: $poolDayDataCount, orderBy: date, orderDirection: desc) {\n      date\n      open\n      close\n      low\n      high\n      volumeUSD\n      tvlUSD\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
