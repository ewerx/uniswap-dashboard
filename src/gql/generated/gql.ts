...
const documents = {
    ...
    "query Tokens($first: Int = 100, $skip: Int = 0, $orderBy: Token_orderBy = totalValueLockedUSD, $orderDirection: OrderDirection = desc) {\n  tokens(\n    first: $first\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    id\n    symbol\n    name\n    totalValueLockedUSD\n    volumeUSD\n  }\n}": types.TokensDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query Tokens($first: Int = 100, $skip: Int = 0, $orderBy: Token_orderBy = totalValueLockedUSD, $orderDirection: OrderDirection = desc) {\n  tokens(\n    first: $first\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    id\n    symbol\n    name\n    totalValueLockedUSD\n    volumeUSD\n  }\n}"): (typeof documents)["query Tokens($first: Int = 100, $skip: Int = 0, $orderBy: Token_orderBy = totalValueLockedUSD, $orderDirection: OrderDirection = desc) {\n  tokens(\n    first: $first\n    skip: $skip\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    id\n    symbol\n    name\n    totalValueLockedUSD\n    volumeUSD\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
