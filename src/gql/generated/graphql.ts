...
export type PoolsQuery = {
  ...
  pools: Array<{
    ...
    volumeUSD: any;
    token0: { __typename?: "Token"; symbol: string; name: string };
    token1: { __typename?: "Token"; symbol: string; name: string };
    poolDayData: Array<{
      __typename?: "PoolDayData";
      date: number;
      open: any;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          defaultValue: { kind: "EnumValue", value: "totalValueLockedUSD" },
        },
        {
          kind: "VariableDefinition",
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "poolDayDataCount" },
          },
          type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "poolDayDataOrderBy" },
          },
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "PoolDayData_orderBy" },
          },
          defaultValue: { kind: "EnumValue", value: "date" },
        },
        {
          kind: "VariableDefinition",
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "poolDayDataOrderDirection" },
          },
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "OrderDirection" },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "poolDayData" },
                  arguments: [
                    {
                      kind: "Argument",
                      name: { kind: "Name", value: "first" },
                    ...
                    },
                    {
                      ...
                      value: {
                        ...
                        name: {
                          kind: "Name",
                          value: "poolDayDataOrderDirection",
                        },
                      },
                    },
                  ],
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "Token_orderBy" },
          },
          defaultValue: { kind: "EnumValue", value: "totalValueLockedUSD" },
        },
        {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "Transaction_orderBy" },
          },
        ...
        },
        {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "Transaction_filter" },
          },
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "amount0" },
                      },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "amount1" },
                      },
                      {
                        kind: "Field",
